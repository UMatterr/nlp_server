...
from Generation.nlpbook.generation.arguments import GenerationTrainArguments


logger = logging.getLogger("umatter")
...
class CustomCorpus:
    ...
    def _create_examples(self, lines):
        ...
        for (i, line) in enumerate(lines):
            if i == 0:
                continue
            _, sentence, category = line
            category = "새해" if category == "0" else "etc"
            text = category + " " + sentence
